            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                    ...
                    Text("Total Hospital :$ind",style: TextStyle(fontSize: 20,color : Colors.white),),
                    Text("Beds :$inter",style: TextStyle(fontSize: 20,color : Colors.white),),
                    Text("Total Hospitals in urban Area :$recover",style: TextStyle(fontSize: 20,color : Colors.white),),
                    Text("Beds :$death",style: TextStyle(fontSize: 20,color : Colors.white),),
                    Text("Total Hospitals in rural area:$hospital",style: TextStyle(fontSize: 20,color : Colors.white),),
                    Text("Beds :$beds",style: TextStyle(fontSize: 20,color : Colors.white),),
